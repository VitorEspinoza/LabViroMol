        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Doi = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    PublicationDate = table.Column<DateOnly>(type: "date", nullable: false),
                    PublishedOn = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    PublishUrl = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    Translations = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", maxLength: 15, nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CitationName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Name_DisplayName = table.Column<string>(type: "text", nullable: true),
                    LattesUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    DegreeLevel = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
