...
public sealed class ActivateMaterialTypeHandler : ICommandHandler<ActivateMaterialTypeCommand, Result>
{
    ...
    public ActivateMaterialTypeHandler(
    ...
    public async ValueTask<Result> Handle(ActivateMaterialTypeCommand command, CancellationToken ct)
    {
        ...
        materialType.Activate(_currentUser.Id);
